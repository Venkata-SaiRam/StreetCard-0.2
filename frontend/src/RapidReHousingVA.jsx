        ...
        return (
            <Form {...formItemLayout} name="enrollment"
                ...
                <Collapse  style={{backgroundColor: "#f0f9ff"}}>
                    <EnrollmentDetails personalProps={this.props} value = {personal} onChangeValue={this.onChangeValueHandler}/>
                    <IncomeAndSource incomeSource={this.props}/>
                    <NonCashBenefits nonCash={this.props} value={nonCashValue} onChangeValue={this.onChangeValueHandler}/>
